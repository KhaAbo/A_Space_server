...
def parse_args():
    ...
    parser.add_argument("--model", type=str, default="resnet50", help="Model name, default `resnet50`")
    parser.add_argument(
        "--weights",
        type=str,
        default="resnet50.pt",
    ...
    parser.add_argument("--no-view", action="store_true", help="Do not display the inference results")
...
def main(params):
    ...
    try:
        gaze_detector = get_model(arch=params.model, bins=params.bins, inference_mode=True)
