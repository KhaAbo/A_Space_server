...
class RetinaPredNetFPContext(nn.Module):
    def __init__(self, num_anchor_per_pixel=1, num_classes=1, \
                 input_ch_list=[256, 256, 256, 256, 256, 256], \
                 use_mask_fp_context=False, fp_th=0.5,
...
class MogPredNet(nn.Module):
    def __init__(self, num_anchor_per_pixel=1, num_classes=1, \
                 input_ch_list=[256, 256, 256, 256, 256, 256], \
                 use_deep_head=False, deep_head_with_gn=False, use_ssh = False, use_cpm=False, use_dsfd=False, deep_head_ch=256, retina_cls_weight_init_fn=None):
